<template>
  <div>
    ...
    <!--字典弹窗-->
    <HelpCtgModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="helpCtg-helpCtg" setup>
  //ts语法
  import {ref, reactive, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import HelpCtgModal from './components/HelpCtgModal.vue';
  import {columns, searchFormSchema, superQuerySchema} from './HelpCtg.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteHelpCtg, batchDeleteHelpCtg, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './HelpCtg.api';
  ...
  async function handleDelete(record) {
    await deleteHelpCtg({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteHelpCtg({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
